import { serial, pgTable, varchar, integer, timestamp, jsonb, primaryKey, bigint, boolean, pgEnum, } from "drizzle-orm/pg-core";
...
export const usersToPanels = pgTable("users_to_panels", {
...
export const panelGroupsToInheritedGroups = pgTable("panelGroupsToInheritedGroups", {
...
export const panelGroupsToInheritedGroupsRelations = relations(panelGroupsToInheritedGroups, ({ one }) => ({
...
export const gameGroupsToInheritedGroups = pgTable("gameGroupsToInheritedGroups", {
    inheritingGroupId: integer("inheriting_group_id")
        .notNull()
        .references(() => gameGroups.id, { onDelete: "cascade" }),
    inheritedGroupId: integer("inherited_group_id")
...
export const gameGroupsToInheritedGroupsRelations = relations(gameGroupsToInheritedGroups, ({ one }) => ({
...
export const playerStatisticsRelations = relations(playerStatistics, ({ many }) => ({
