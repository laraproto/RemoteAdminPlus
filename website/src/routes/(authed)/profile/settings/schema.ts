...
}).refine((data) => data.currentPassword !== data.newPassword, "New password must be different from current password").refine((data) => data.newPassword === data.confirmNewPassword, "New password and confirmation do not match");
